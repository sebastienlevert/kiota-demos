...
namespace GitHubDemo.GitHub.Orgs.Item.Repos {
    ...
    public class ReposRequestBuilder {
        ...
        public ReposRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/orgs/{org}/repos{?type*,sort*,direction*,per_page*,page*}";
        ...
        /// API method documentation <see href="https://docs.github.com/rest/reference/repos#list-organization-repositories" />
        /// </summary>
...
#nullable restore
        ...
        public async Task<List<MinimalRepository>> GetAsync(Action<ReposRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<MinimalRepository>(requestInfo, MinimalRepository.CreateFromDiscriminatorValue, default, cancellationToken);
        ...
        /// API method documentation <see href="https://docs.github.com/rest/reference/repos#create-an-organization-repository" />
        /// </summary>
