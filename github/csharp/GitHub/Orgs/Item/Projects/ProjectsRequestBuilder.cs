using GitHubDemo.GitHub.Models;
...
namespace GitHubDemo.GitHub.Orgs.Item.Projects {
    /// <summary>
    ...
    public class ProjectsRequestBuilder {
        ...
        public ProjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/orgs/{org}/projects{?state*,per_page*,page*}";
        ...
        /// API method documentation <see href="https://docs.github.com/rest/reference/projects#list-organization-projects" />
        /// </summary>
...
#nullable restore
        ...
        public async Task<List<Project>> GetAsync(Action<ProjectsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<Project>(requestInfo, Project.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
            return collectionResult?.ToList();
        }
        /// <summary>
        /// Creates an organization project board. Returns a `410 Gone` status if projects are disabled in the organization or if the organization does not have existing classic projects. If you do not have sufficient privileges to perform this action, a `401 Unauthorized` or `410 Gone` status is returned.
        /// API method documentation <see href="https://docs.github.com/rest/reference/projects#create-an-organization-project" />
        /// </summary>
...
#nullable restore
        ...
        public async Task<Project> PostAsync(ProjectsPostRequestBody body, Action<ProjectsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendAsync<Project>(requestInfo, Project.CreateFromDiscriminatorValue, errorMapping, cancellationToken);
        }
        /// <summary>
        /// Lists the projects in an organization. Returns a `404 Not Found` status if projects are disabled in the organization. If you do not have sufficient privileges to perform this action, a `401 Unauthorized` or `410 Gone` status is returned.
        /// </summary>
