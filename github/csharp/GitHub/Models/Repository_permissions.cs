...
namespace GitHubDemo.GitHub.Models {
    public class Repository_permissions : IParsable {
        ...
        public static Repository_permissions CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Repository_permissions();
        }
        /// <summary>
