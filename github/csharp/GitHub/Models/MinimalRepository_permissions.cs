...
namespace GitHubDemo.GitHub.Models {
    public class MinimalRepository_permissions : IParsable {
        ...
        public static MinimalRepository_permissions CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new MinimalRepository_permissions();
        }
        /// <summary>
