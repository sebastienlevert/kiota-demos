...
namespace GitHubDemo.GitHub.Models {
    ...
    /// Minimal Repository
    /// </summary>
    public class MinimalRepository : IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GitHubDemo.GitHub.Models.CodeOfConduct? CodeOfConduct { get; set; }
#nullable restore
#else
        public GitHubDemo.GitHub.Models.CodeOfConduct CodeOfConduct { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public MinimalRepository_license? License { get; set; }
#nullable restore
#else
        public MinimalRepository_license License { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public MinimalRepository_permissions? Permissions { get; set; }
#nullable restore
#else
        public MinimalRepository_permissions Permissions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GitHubDemo.GitHub.Models.SecurityAndAnalysis? SecurityAndAnalysis { get; set; }
#nullable restore
#else
        public GitHubDemo.GitHub.Models.SecurityAndAnalysis SecurityAndAnalysis { get; set; }
#endif
...
#nullable restore
        ...
        public static MinimalRepository CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"code_of_conduct", n => { CodeOfConduct = n.GetObjectValue<GitHubDemo.GitHub.Models.CodeOfConduct>(GitHubDemo.GitHub.Models.CodeOfConduct.CreateFromDiscriminatorValue); } },
                ...
                {"license", n => { License = n.GetObjectValue<MinimalRepository_license>(MinimalRepository_license.CreateFromDiscriminatorValue); } },
                ...
                {"permissions", n => { Permissions = n.GetObjectValue<MinimalRepository_permissions>(MinimalRepository_permissions.CreateFromDiscriminatorValue); } },
                ...
                {"security_and_analysis", n => { SecurityAndAnalysis = n.GetObjectValue<GitHubDemo.GitHub.Models.SecurityAndAnalysis>(GitHubDemo.GitHub.Models.SecurityAndAnalysis.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GitHubDemo.GitHub.Models.CodeOfConduct>("code_of_conduct", CodeOfConduct);
            ...
            writer.WriteObjectValue<MinimalRepository_license>("license", License);
            ...
            writer.WriteObjectValue<MinimalRepository_permissions>("permissions", Permissions);
            ...
            writer.WriteObjectValue<GitHubDemo.GitHub.Models.SecurityAndAnalysis>("security_and_analysis", SecurityAndAnalysis);
