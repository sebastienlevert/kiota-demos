...
namespace GitHubDemo.GitHub.Models {
    public class Repository_template_repository_owner : IParsable {
...
#nullable restore
        ...
        public static Repository_template_repository_owner CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Repository_template_repository_owner();
        }
        /// <summary>
