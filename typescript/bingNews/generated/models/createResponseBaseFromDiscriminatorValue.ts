...
import {Answer, Article, CreativeWork, Identifiable, ImageObject, MediaObject, News, NewsArticle, NewsTopic, Organization, Response, ResponseBase, SearchResultsAnswer, Thing, TrendingTopics, VideoObject} from './index';
import {ParseNode} from '@microsoft/kiota-abstractions';

export function createResponseBaseFromDiscriminatorValue(parseNode: ParseNode | undefined) {
    ...
    if (mappingValueNode) {
        ...
        if (mappingValue) {
            switch (mappingValue) {
                ...
                case "Identifiable":
                    return deserializeIntoIdentifiable;
                case "ImageObject":
    ...
    return deserializeIntoResponseBase;
}
