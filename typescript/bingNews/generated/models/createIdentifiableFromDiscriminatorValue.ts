...
import {Answer, Article, CreativeWork, Identifiable, ImageObject, MediaObject, News, NewsArticle, NewsTopic, Organization, Response, SearchResultsAnswer, Thing, TrendingTopics, VideoObject} from './index';
import {ParseNode} from '@microsoft/kiota-abstractions';

export function createIdentifiableFromDiscriminatorValue(parseNode: ParseNode | undefined) {
